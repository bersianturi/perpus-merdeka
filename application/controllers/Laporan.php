...
class Laporan extends MY_Controller
{
    ...
    {
        $data = array('title' => 'Laporan Anggota', 'anggota' => $this->Mod_anggota->getAll());
    ...
    {
        $data = array('title' => 'Laporan Buku', 'buku' => $this->Mod_buku->getAll());
    ...
    {
        $data = array('title' => 'Laporan Peminjaman', 'peminjaman' => $this->Mod_laporan->getAllPeminjaman());
    ...
    {
        $data = array('title' => 'Laporan pengembalian', 'pengembalian' => $this->Mod_laporan->getAllpengembalian());
