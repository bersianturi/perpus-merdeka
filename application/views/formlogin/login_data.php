...
<head>
    ...
    <title>Login | UAS-Perpustakaan</title>
...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>PERPUSTAKAAN-UAS</strong></a>
        </div>
...
<div class="row">
    ...
    <div class="col-md-8 ">
        <h2> Selamat Datang di Perpustakaan</h2><hr class="line-title"> 
