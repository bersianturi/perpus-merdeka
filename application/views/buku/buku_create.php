          ...
          <div class="card-body">
            <form>
              <div class="form-group">
                ...
                <input type="text" id="kode_buku" name="kode_buku" class="form-control" placeholder="Kode Buku" value="<?php echo set_value('kode_buku'); ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-g roup">
                ...
                <textarea name="klasifikasi" class="form-control" rows="4"><?php echo set_value('klasifikasi'); ?></textarea>
              </div>
              <div class="form-group">
                <label>Images</label>
