            ...
            <div class="grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="<?= base_url('laporan/cetak_pengembalian') ?>" class="btn btn-gradient-info btn-rounded mx-1"><i class="mdi mdi-printer"></i> Print</a>
                                <a href="<?= base_url('laporan/cetak_pengembalian_pdf') ?>" class="btn btn-gradient-danger btn-rounded mx-1"><i class="mdi mdi-file-pdf"></i> PDF</a>
                                <a href="<?= base_url('laporan/cetak_pengembalian_excel') ?>" class="btn btn-gradient-success btn-rounded mx-1"><i class="mdi mdi-file-excel"></i> Excel</a>
                            </div>
                            <div class="col-md-6">
